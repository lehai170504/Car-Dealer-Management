    ...
    <div className="min-h-screen bg-gray-800 p-8 text-gray-100"> 
      <div className="space-y-8 max-w-7xl mx-auto"> 
        ...
        <div className="flex items-center justify-between border-b border-gray-700 pb-4">
          ...
          <Button 
            onClick={() => console.log("Thêm Đại lý mới")}
        ...
        <Tabs defaultValue="list" className="w-full">
          ...
          <TabsContent value="list" className="pt-6">
            <div className="bg-gray-700/50 p-6 rounded-xl shadow-xl border border-gray-700">
                <h2 className="text-2xl font-bold mb-4 text-white border-b border-gray-600 pb-2">Danh sách Đại lý và Hiệu suất</h2>
                <EVM_DealerList /> 
            </div>
          </TabsContent>
          ...
          <TabsContent value="finance" className="pt-6">
            <div className="bg-gray-700/50 p-6 rounded-xl shadow-xl border border-gray-700">
                <h2 className="text-2xl font-bold mb-4 text-white border-b border-gray-600 pb-2">Quản lý Công nợ và Doanh số theo Đại lý</h2>
          ...
          <TabsContent value="accounts" className="pt-6">
            <div className="bg-gray-700/50 p-6 rounded-xl shadow-xl border border-gray-700">
                <h2 className="text-2xl font-bold mb-4 text-white border-b border-gray-600 pb-2">Quản lý Tài khoản EVM và Đại lý</h2>
